...
func TestDemultiplex(t *testing.T) {
	...
	nqmFpingItems, _, _, genericItems := queue.Demultiplex(caseIn)
...
func TestConvert2NqmMetrics(t *testing.T) {
	...
	out_ptr, _ := queue.Convert2NqmMetrics(&in)
	out := nqmMetrics{
		Rttmin:      18,
		Rttavg:      21,
		Rttmax:      26,
	...
	in.Tags["rttmin"] = "qqqq"
	out_ptr_e, err := queue.Convert2NqmMetrics(&in)
	if out_ptr_e != nil {
...
func TestJsonMarshal(t *testing.T) {
	...
	m_out, _ := queue.Convert2NqmMetrics(in)
